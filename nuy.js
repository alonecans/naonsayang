...
nuy.sendMessage(from, hasil, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "ketik #menu kak", 'jpegThumbnail': fs.readFileSync('./sticker/manca.webp')}}}})
		...
		reply(`*_「 ʙᴀᴅᴡᴏʀᴅ ᴅᴇᴛᴇᴄᴛᴇᴅ 」_*\nᴍᴀᴀғ *${pushname2}* ᴀɴᴅᴀ ʙᴇʀʙɪᴄᴀʀᴀ ᴋᴏᴛᴏʀ!, ᴀɴᴅᴀ ꜱᴇɢᴇʀᴀ ᴅɪᴋɪᴄᴋ ᴅᴀʀɪ ɢʀᴜᴘ *${groupMetadata.subject}*`)
			...
			if (!isCmd && isGroup) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;31mRECV\x1b[1;37m]', time, color('Message'), 'from', color(sender.split('@')[0]), 'in', color(groupName), 'args :', color(args.length))
              ...
              captionnya = `╓───「 *_ᴍᴀɴᴄᴀ ʙᴏᴛ_* 」
❏https://www.instagram.com/thenay_xploit_
╙───々
╓───「 *_ʙᴏᴛ ɪɴғᴏ_* 」
❏ ᴄʀᴇᴀᴛᴏʀ: ғxsx
❏ ʀᴇᴄᴏᴅᴇ ʙʏ: ᴍᴀɴᴄᴀ ᴛᴇᴀᴍ
❏ ᴘʀᴇғɪx: ${prefix}
...
reply(mess.wait)
my = body.slice(5)
pper = await getBuffer(`https://lindow-api.herokuapp.com/api/writestars?text=${my}&apikey=LindowApi`)
nuy.sendMessage(from, pper, image, {quoted: mek})
await limitAdd(sender)
break
case 'goldenros':
...
// akhir fitur anime
			...
			case 'hekerbucin':
				...
				if (!isUrl(args[0]) && !args[0].includes('tiktok.com')) return reply(mess.error.lv)
					 ige = body.slice(12)
                     anu = await fetchJson(`https://lindow-api.herokuapp.com/api/tiktod/?url=${args[0]}&apikey=LindowApi`, {method: 'get'})
					if (anu.error) return reply(anu.error)
...
case 'husbu':
        ...
        nuy.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : dj iri bilang babi", 'jpegThumbnail': fs.readFileSync('./sticker/manca.webp')}}}})
        }
        ...
        nuy.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "mau ngapain?", 'jpegThumbnail': fs.readFileSync('./sticker/manca.webp')}}}})
        }
